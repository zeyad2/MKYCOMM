...
export default function ServiceCard({
  ...
  return (
    <div
      className="flex flex-col xl:flex-row gap-8 items-start  pb-6 border-b border-[#797979]">
      {/* Content */}
      ...
      {/* Image */}
      <div className="w-full xl:w-[638px]   h-[150px] p-[24px] relative rounded-[16px] overflow-hidden flex-shrink-0">
        <Image
          src={imageSrc}
          alt={imageAlt}
          fill
